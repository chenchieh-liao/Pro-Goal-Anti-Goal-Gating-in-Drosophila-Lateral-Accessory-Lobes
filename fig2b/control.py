...
# 繪製 ax4
ax4.plot(trace_DNa01[0].t/ms, trace_DNa01[0].r, color='red', label='right DNa01', linewidth=line_width)
ax4.plot(trace_DNa01[1].t/ms, trace_DNa01[1].r, color='blue', label='left DNa01', linewidth=line_width)
ax4.title.set_text('DNa01')
ax4.title.set_size(24)
ax4.tick_params(axis='both', labelsize=14)

# 繪製 ax5
ax5.plot(trace_DNa02[0].t/ms, trace_DNa02[0].r, color='red', label='right DNa02', linewidth=line_width)
ax5.plot(trace_DNa02[1].t/ms, trace_DNa02[1].r, color='blue', label='left DNa02', linewidth=line_width)
...
ax6.set_xlabel('Time (ms)', fontsize=22)
...
# 繪製 ax8
ax8.plot(trace_lal073[0].t/ms, trace_lal073[0].r, color='red', label='right lal046', linewidth=line_width)
ax8.plot(trace_lal073[1].t/ms, trace_lal073[1].r, color='blue', label='left lal046', linewidth=line_width)
ax8.title.set_text('DI4')
ax8.title.set_size(24)
ax8.tick_params(axis='both', labelsize=14)


# 繪製 ax9
ax9.plot(trace_DNa03[0].t/ms, trace_DNa03[0].r, color='red', label='right DNa03', linewidth=line_width)
ax9.plot(trace_DNa03[1].t/ms, trace_DNa03[1].r, color='blue', label='left DNa03', linewidth=line_width)
ax9.title.set_text('DNa03')
ax9.title.set_size(24)
ax9.tick_params(axis='both', labelsize=14)

# 繪製 ax10
ax10.plot(trace_DNa04[0].t/ms, trace_DNa04[0].r, color='red', label='right DNa04', linewidth=line_width)
ax10.plot(trace_DNa04[1].t/ms, trace_DNa04[1].r, color='blue', label='left DNa04', linewidth=line_width)
...
# 在右側添加圖例
fig.legend(
    labels=['right side', 'left side'],  # 圖例標籤
    loc='center right',                 # 位置設置為右側
    fontsize=18,                        # 字體大小
