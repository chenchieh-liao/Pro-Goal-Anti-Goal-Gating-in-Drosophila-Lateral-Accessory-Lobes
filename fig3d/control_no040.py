...
f = open(f'/home/chieh1102/FPLmodel/open-loop_v5/fig3d/data_no040/dna02_{inp_g-inp_h}_{sys.argv[2]}_{sys.argv[3]}.txt', 'a')
...
fig.suptitle('no 040 output  Δθ = 0°', fontsize=18)
