...
f = open("para_0701v14-5.json")
paras = json.load(f)

seed_ = np.random.randint(10000)
f3 = open("seedpfl2.txt",'a+')
print(f'{seed_}\n',file = f3)
seed(seed_)
...
f = open(f'/home/chieh1102/FPLmodel/open-loop_v5/fig3d/data_noPFL2/dna02_{inp_g-inp_h}_{sys.argv[2]}_{sys.argv[3]}.txt', 'a')
