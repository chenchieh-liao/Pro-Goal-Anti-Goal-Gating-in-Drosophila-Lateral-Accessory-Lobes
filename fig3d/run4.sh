...
# 定義範圍
ranges=( "0.07" "0.06" "0.05" "0.04" "0.03" "0.02" "0.01" "0" )
...
do
    ...
    for w0 in $(seq 1 50)
    do
        python3 control_full.py    0 ${range} $w0 & 
        python3 control_no121.py   0 ${range} $w0 &
        python3 control_noPFL2.py  0 ${range} $w0 &
        python3 control_noexcc.py  0 ${range} $w0 &
