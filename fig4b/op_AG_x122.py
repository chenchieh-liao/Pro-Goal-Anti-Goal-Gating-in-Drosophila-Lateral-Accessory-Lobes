...
LAL153[1].I_mean = int(sys.argv[3])
LAL046[1].I_mean = int(sys.argv[3])
LAL017[0].I_mean = int(sys.argv[3])*0.2
...
base_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_x122')
