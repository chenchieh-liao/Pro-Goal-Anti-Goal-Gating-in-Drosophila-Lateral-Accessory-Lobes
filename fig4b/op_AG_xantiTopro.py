...
def custom_network_operation(t):
    ...
    LAL153[1].I = int(sys.argv[3]) + noise * np.random.randn()
    LAL046[1].I = int(sys.argv[3]) + noise * np.random.randn()
    LAL017[0].I = int(sys.argv[3])*0.2 + noise * np.random.randn()
...
base_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_xantiTopro')
