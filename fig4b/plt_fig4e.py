...
data_anti_dir = os.path.join(base_dir, 'data_x122')
...
for i, (ax, file1, file2) in enumerate(zip(axes, output_files_group1, output_files_group2)):
    ...
    ax.plot(x3, y3_1, label='LAL122 lesion L', color='blue', linewidth=line_width)
    ax.plot(x3, y3_2, label='LAL122 lesion R', color='red', linewidth=line_width)
