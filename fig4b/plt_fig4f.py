...
data_anti_dir = os.path.join(base_dir, 'data_017_0.6')
...
for i, (ax, file1, file2) in enumerate(zip(axes, output_files_group1, output_files_group2)):
    ...
    ax.plot(x2, y2_1, label='Strengthen LAL017 L', color='blue', linewidth=line_width)
    ax.plot(x2, y2_2, label='Strengthen LAL017 R', color='red', linewidth=line_width)
