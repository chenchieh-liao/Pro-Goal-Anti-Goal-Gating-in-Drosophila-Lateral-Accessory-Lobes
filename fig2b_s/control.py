...
pfl2_head = [337.5,22.5,67.5,112.5,157.5,202.5,247.5,292.5 ]
...
# f = open(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2b/data_ctr/dna02_{inp_g-inp_h}_{sys.argv[2]}_{sys.argv[3]}.txt', 'a')
...
# 設定統一的線條粗細
line_width = 4  # 修改此參數以調整線條粗細

# 創建子圖
fig, ((ax1, ax2, ax3, ax4, ax5), (ax6, ax7, ax8, ax9, ax10),(ax11, ax12, ax13, ax14, ax15)) = plt.subplots(3, 5, sharex=False, sharey=True, dpi=300, figsize=[12, 12])
fig.suptitle('Full model  Δθ = 90°', fontsize=28)

# 繪製 ax1
ax1.plot(trace_lal010[0].t/ms, trace_lal010[0].r, color='red', label='right lal010', linewidth=line_width)
ax1.plot(trace_lal010[1].t/ms, trace_lal010[1].r, color='blue', label='left lal010', linewidth=line_width)
ax1.title.set_text('DE1')
ax1.title.set_size(24)
ax1.tick_params(axis='both', labelsize=16,width=3,length=7)
# ax1.set_ylabel('firing rate', fontsize=22)
# 移除 ax1 的邊框，但保留 y 軸數字標示
...
# 繪製 ax2
ax2.plot(trace_lal014[0].t/ms, trace_lal014[0].r, color='red', label='right lal014', linewidth=line_width)
ax2.plot(trace_lal014[1].t/ms, trace_lal014[1].r, color='blue', label='left lal014', linewidth=line_width)
ax2.title.set_text('DE2')
ax2.title.set_size(24)
ax2.tick_params(axis='both', labelsize=14)

# 繪製 ax3
ax3.plot(trace_lal018[0].t/ms, trace_lal018[0].r, color='red', label='right lal018', linewidth=line_width)
ax3.plot(trace_lal018[1].t/ms, trace_lal018[1].r, color='blue', label='left lal018', linewidth=line_width)
ax3.title.set_text('DE3')
ax3.title.set_size(24)
ax3.tick_params(axis='both', labelsize=14)

# 繪製 ax4
ax4.plot(trace_lal153[0].t/ms, trace_lal153[0].r, color='red', label='right VE1', linewidth=line_width)
ax4.plot(trace_lal153[1].t/ms, trace_lal153[1].r, color='blue', label='left VE1', linewidth=line_width)
ax4.title.set_text('VE1')
ax4.title.set_size(24)
ax4.tick_params(axis='both', labelsize=14)

# 繪製 ax5
ax5.plot(trace_lal017[0].t/ms, trace_lal017[0].r, color='red', label='right VE2', linewidth=line_width)
ax5.plot(trace_lal017[1].t/ms, trace_lal017[1].r, color='blue', label='left VE2', linewidth=line_width)
ax5.title.set_text('VE2')
ax5.title.set_size(24)
ax5.tick_params(axis='both', labelsize=14)

# 繪製 ax6
ax6.plot(trace_lal040[0].t/ms, trace_lal040[0].r, color='red', label='right lal040', linewidth=line_width)
ax6.plot(trace_lal040[1].t/ms, trace_lal040[1].r, color='blue', label='left lal040', linewidth=line_width)
ax6.title.set_text('DI1')
ax6.title.set_size(24)
ax6.tick_params(axis='both', labelsize=16,width=3,length=7)
ax6.set_ylabel('Firing rate', fontsize=22)
# 移除 ax6 的邊框，但保留 y 軸數字標示
...
# 繪製 ax7
ax7.plot(trace_lal121[0].t/ms, trace_lal121[0].r, color='red', label='right lal121', linewidth=line_width)
ax7.plot(trace_lal121[1].t/ms, trace_lal121[1].r, color='blue', label='left lal121', linewidth=line_width)
ax7.title.set_text('DI2')
ax7.title.set_size(24)
ax7.tick_params(axis='both', labelsize=14)

# 繪製 ax8
ax8.plot(trace_lal126[0].t/ms, trace_lal126[0].r, color='red', label='right lal126', linewidth=line_width)
ax8.plot(trace_lal126[1].t/ms, trace_lal126[1].r, color='blue', label='left lal126', linewidth=line_width)
ax8.title.set_text('DI3')
ax8.title.set_size(24)
ax8.tick_params(axis='both', labelsize=14)

# 繪製 ax9
ax9.plot(trace_lal073[0].t/ms, trace_lal073[0].r, color='red', label='right 046', linewidth=line_width)
ax9.plot(trace_lal073[1].t/ms, trace_lal073[1].r, color='blue', label='left 046', linewidth=line_width)
ax9.title.set_text('DI4')
ax9.title.set_size(24)
ax9.tick_params(axis='both', labelsize=14)

# 繪製 ax10
ax10.plot(trace_lal122[0].t/ms, trace_lal122[0].r, color='red', label='right 073', linewidth=line_width)
ax10.plot(trace_lal122[1].t/ms, trace_lal122[1].r, color='blue', label='left 073', linewidth=line_width)
ax10.title.set_text('VI1')
ax10.title.set_size(24)
ax10.tick_params(axis='both', labelsize=14)

# 繪製 ax11
ax11.plot(trace_lal046[0].t/ms, trace_lal046[0].r, color='red', label='right lal122', linewidth=line_width)
ax11.plot(trace_lal046[1].t/ms, trace_lal046[1].r, color='blue', label='left lal122', linewidth=line_width)
ax11.title.set_text('VI2')
ax11.title.set_size(24)
ax11.tick_params(axis='both', labelsize=16,width=3,length=7)
# ax11.set_ylabel('firing rate', fontsize=22)
# 移除 ax11 的邊框，但保留 y 軸數字標示
ax11.spines['top'].set_visible(False)
ax11.spines['right'].set_visible(False)
ax11.tick_params(axis='y', labelleft=True)

ax12.plot(trace_DNa01[0].t/ms, trace_DNa01[0].r, color='red', label='right 01', linewidth=line_width)
ax12.plot(trace_DNa01[1].t/ms, trace_DNa01[1].r, color='blue', label='left 01', linewidth=line_width)
ax12.title.set_text('DNa01')
ax12.title.set_size(24)
ax12.tick_params(axis='both', labelsize=14)

ax13.plot(trace_DNa02[0].t/ms, trace_DNa02[0].r, color='red', label='right 02', linewidth=line_width)
ax13.plot(trace_DNa02[1].t/ms, trace_DNa02[1].r, color='blue', label='left 02', linewidth=line_width)
ax13.title.set_text('DNa02')
ax13.title.set_size(24)
ax13.tick_params(axis='both', labelsize=14)
ax13.set_xlabel('Time (ms)', fontsize=22, loc='left')

ax14.plot(trace_DNa03[0].t/ms, trace_DNa03[0].r, color='red', label='right 03', linewidth=line_width)
ax14.plot(trace_DNa03[1].t/ms, trace_DNa03[1].r, color='blue', label='left 03', linewidth=line_width)
ax14.title.set_text('DNa03')
ax14.title.set_size(24)
ax14.tick_params(axis='both', labelsize=14)

ax15.plot(trace_DNa04[0].t/ms, trace_DNa04[0].r, color='red', label='right 04', linewidth=line_width)
ax15.plot(trace_DNa04[1].t/ms, trace_DNa04[1].r, color='blue', label='left 04', linewidth=line_width)
ax15.title.set_text('DNa04')
ax15.title.set_size(24)
ax15.tick_params(axis='both', labelsize=14)
...
# 隱藏不需要的框框與標籤，保留 x 軸刻度
for ax in [ax2, ax3, ax4, ax5, ax7, ax8, ax9, ax10]:
    ax.spines['top'].set_visible(False)
    ax.spines['right'].set_visible(False)
    ax.spines['left'].set_visible(False)
    ax.tick_params(left=False,width=3,length=7)  # 隱藏 y 軸刻度
    ax.set_yticklabels([])  # 移除 y 軸標籤
    ax.tick_params(labelbottom=False,width=3,length=7)  # 隱藏 x 軸標籤，但保留刻度
    ax.set_xticks(xticks)

for ax in [ax12, ax13, ax14, ax15]:
    ax.spines['top'].set_visible(False)
    ax.spines['right'].set_visible(False)
    ax.spines['left'].set_visible(False)
    ax.tick_params(left=False,width=3,length=7)  # 隱藏 y 軸刻度
    ax.set_yticklabels([])  # 移除 y 軸標籤
    ax.tick_params(width=3,length=7)  # 隱藏 x 軸標籤，但保留刻度
    ax.set_xticks(xticks)

yticks = np.arange(0, 1.1, 0.2) # [0, 20, 40, 60, 80, 100]
ax1.set_yticks(yticks)
ax1.set_yticklabels([f"{y:.1f}" for y in yticks], fontsize=16)

ax6.set_yticks(yticks)
ax6.set_yticklabels([f"{y:.1f}" for y in yticks], fontsize=16)

# 調整軸線粗細
for ax in [ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9, ax10, ax11, ax12, ax13, ax14, ax15]:
    for spine in ax.spines.values():
        spine.set_linewidth(3)  # 設定軸線粗細

# 在右側添加圖例
fig.legend(
    labels=['right', 'left'],  # 圖例標籤
    loc='upper right',                 # 位置設置為右側
    bbox_to_anchor=(0.85, 1.015),
    fontsize=18,                        # 字體大小
    frameon=False,                      # 隱藏圖例邊框
)
...
# 保存圖片
# plt.savefig(f'fig2b_{seed_}.svg')

plt.savefig('fig2b_s_3060.png', bbox_inches='tight', dpi=300)
end  = time.time()
