...
def custom_network_operation(t):
    ...
    # Phase 5: t >= 102 ms - 進入主迴圈更新動作
        ...
        if not hasattr(custom_network_operation, 'loop_initialized'):
            ...
            total_input017 = int(sys.argv[6])*0.6
        ...
        if (goal - head) > 0:
            ...
            if (delta > 30 and delta < 145):
                ...
                LAL153[1].I = LAL153_input + noise
                LAL153[0].I = total_input153 - LAL153_input + noise
                LAL046[1].I = LAL153_input + noise
                LAL046[0].I = total_input153 - LAL153_input + noise
                LAL017[0].I = LAL017_input + noise
                LAL017[1].I = total_input017 - LAL017_input + noise
            ...
            if (delta < -30 and delta > -145):
                LAL153_input = total_input153
                LAL017_input = total_input017
                LAL153[0].I = LAL153_input + noise
                LAL153[1].I = total_input153 - LAL153_input + noise
                LAL046[0].I = LAL153_input + noise
                LAL046[1].I = total_input153 - LAL153_input + noise
                LAL017[1].I = LAL017_input + noise
                LAL017[0].I = total_input017 - LAL017_input + noise
            elif (delta <= -165):
                LAL153[0].I = 0
                LAL153[1].I = 0
                LAL046[0].I = 0
