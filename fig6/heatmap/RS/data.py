...
# 測試處理多個文件
process_files(["LAL010.txt","LAL014.txt","LAL018.txt","LAL040.txt","LAL046.txt","LAL121.txt","LAL073.txt","LAL122.txt","LAL126.txt","LAL017.txt","LAL153.txt", "Fullmodel.txt"], "RS.csv")
