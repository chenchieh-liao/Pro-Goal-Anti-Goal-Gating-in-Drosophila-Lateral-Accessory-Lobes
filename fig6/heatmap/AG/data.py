...
def compute_angular_velocity(start_angle, start_time, end_time, final_angle):
    ...
    # 確保 start_time 不是 None
    # if start_time is None:
    #     start_time = 0 # 如果 start_time 無效，返回 0 避免計算錯誤
    start_time = 2000
    # 處理缺失的 end_time
    if end_time is None:
        delta_time = (10000 - start_time) / 10000  # 替代計算時間
    else:
...
# 測試處理多個文件
process_files(["LAL010.txt","LAL014.txt","LAL018.txt","LAL040.txt","LAL046.txt","LAL121.txt","LAL073.txt","LAL122.txt","LAL126.txt","LAL017.txt","LAL153.txt", "Fullmodel.txt"], "AG.csv")
