...
def custom_network_operation(t):
    ...
    # Phase 5: t >= 102 ms - 進入主迴圈更新動作
        ...
        if not hasattr(custom_network_operation, 'loop_initialized'):
            ...
            total_input153 = int(sys.argv[6])/10
            total_input017 = int(sys.argv[7])/10

            LAL126[0].I = int(sys.argv[8])/10
            LAL126[1].I = int(sys.argv[8])/10
        ...
        if custom_network_operation.check == 0 and abs(initialgoal - head)>1:
