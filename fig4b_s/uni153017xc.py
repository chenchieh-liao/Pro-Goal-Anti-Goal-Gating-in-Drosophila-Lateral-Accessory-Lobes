...
LAL153[1].I = int(sys.argv[3])
LAL046[1].I = int(sys.argv[3])
LAL017[0].I = int(sys.argv[3])*0.2
...
output_files = [
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa01.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa02.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa03.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa04.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL010.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL014.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL018.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL040.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL046.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL121.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL073.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL122.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL126.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL153.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_xantiTopro/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL017.txt',
]
...
# 創建子圖
fig, axes = plt.subplots(2, 4, sharex=False, sharey=True, dpi=300, figsize=[14, 8])
fig.suptitle('LAL122 lesion  Δθ = 90°', fontsize=28)
...
# 遍歷每個子圖，並繪製相應的數據
for ax, (title, trace) in zip(axes.flat, trace_data.items()):
    ax.plot(trace[0].t / ms, trace[0].r, color='red', label=f'right {title}', linewidth=line_width)
    ax.plot(trace[1].t / ms, trace[1].r, color='blue', label=f'left {title}', linewidth=line_width)
...
# 為特定子圖添加 x, y 軸標籤
axes[0, 0].set_ylabel('firing rate', fontsize=22)
axes[1, 0].set_ylabel('firing rate', fontsize=22)
axes[1, 0].set_xlabel('Time (ms)', fontsize=22)
