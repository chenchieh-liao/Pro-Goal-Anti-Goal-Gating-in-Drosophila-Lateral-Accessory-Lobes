...
def custom_network_operation(t):
    ...
    noise = sigma * np.sqrt(2/10) * np.sqrt(1/(defaultclock.dt/ms)) * 8

    LAL153[1].I = int(sys.argv[3])/2 + noise * np.random.randn()
    LAL046[1].I = int(sys.argv[3])/2 + noise * np.random.randn()
    LAL017[0].I = int(sys.argv[3])*0.2/2 + noise * np.random.randn()

    LAL153[0].I = int(sys.argv[3])/2 + noise * np.random.randn()
    LAL046[0].I = int(sys.argv[3])/2 + noise * np.random.randn()
    LAL017[1].I = int(sys.argv[3])*0.2/2 + noise * np.random.randn()
...
# output_files = [
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa01.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa02.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa03.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_DNa04.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL010.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL014.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL018.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL040.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL046.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL121.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL073.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL122.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL126.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL153.txt',
#     f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/data_Front2/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL017.txt',
# ]
...
plot(trace_lal010[0].t/ms, trace_lal010[0].I_pfl3, label='LAL010')
plot(trace_lal153[0].t/ms, trace_lal153[0].I, label='LAL153')
legend()
savefig('input_noise.png')

output_files_noise = [
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/noise/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL010_8.txt',
    f'/home/chieh1102/FPLmodel/open-loop_v5/fig4b_s/noise/dna02_{inp_g-inp_h}_{sys.argv[2]}_LAL153_8.txt',
]
...
# 確定每個 trace 的長度相同
length = len(trace_lal010[0].t)
for i in range(length):
    for file_path, trace in zip(output_files_noise, trace_data):
        with open(file_path, 'a') as f:
            f.write(f'{i} {trace[0][i]}\n')   
