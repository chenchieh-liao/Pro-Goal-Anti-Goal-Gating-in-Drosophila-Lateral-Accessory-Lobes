...
# 檔案名稱
filenames_group1 = [
    'dna02_0_0.01_LAL010.txt',
    'dna02_0_0.01_LAL014.txt',
    'dna02_0_0.01_LAL018.txt',
    'dna02_0_0.01_LAL153.txt',
    'dna02_0_0.01_LAL017.txt',
    'dna02_0_0.01_LAL040.txt',
    'dna02_0_0.01_LAL121.txt',
    'dna02_0_0.01_LAL126.txt',
    'dna02_0_0.01_LAL073.txt',
    'dna02_0_0.01_LAL122.txt',
    'dna02_0_0.01_LAL046.txt',
    'dna02_0_0.01_DNa01.txt',
    'dna02_0_0.01_DNa02.txt',
    'dna02_0_0.01_DNa03.txt',
    'dna02_0_0.01_DNa04.txt', 
]

filenames_group2 = [
    'dna02_0_0.07_LAL010.txt',
    'dna02_0_0.07_LAL014.txt',
    'dna02_0_0.07_LAL018.txt',
    'dna02_0_0.07_LAL153.txt',
    'dna02_0_0.07_LAL017.txt',
    'dna02_0_0.07_LAL040.txt',
    'dna02_0_0.07_LAL121.txt',
    'dna02_0_0.07_LAL126.txt',
    'dna02_0_0.07_LAL073.txt',
    'dna02_0_0.07_LAL122.txt',
    'dna02_0_0.07_LAL046.txt',
    'dna02_0_0.07_DNa01.txt',
    'dna02_0_0.07_DNa02.txt',
    'dna02_0_0.07_DNa03.txt',
    'dna02_0_0.07_DNa04.txt', 
]
...
for i, (ax, file1, file2) in enumerate(zip(axes, output_files_group1, output_files_group2)):
    ...
    ax.plot(x2, y2_1, color='blue', linewidth=line_width, alpha=0.3, label='L noise 0.07')
    ax.plot(x2, y2_2, color='red', linewidth=line_width, alpha=0.3, label='R noise 0.07')
...
plt.savefig('fig4M_s.png',dpi= 90)
plt.show()
