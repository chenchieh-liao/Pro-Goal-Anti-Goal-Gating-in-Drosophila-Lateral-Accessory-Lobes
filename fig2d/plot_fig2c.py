...
for data in range(1, 51):
    file10 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_no1014/dna02_10_0.01_{data}.txt', header=None, delimiter=' ')
    file30 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_no1014/dna02_30_0.01_{data}.txt', header=None, delimiter=' ')
    file90 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_no1014/dna02_90_0.01_{data}.txt', header=None, delimiter=' ')
    #file120 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_no1014/dna02_120_0.01_{data}.txt', header=None, delimiter=' ')
    arr10.append(file10[1][0:8000])
    arr30.append(file30[1][0:8000])
    arr90.append(file90[1][0:8000])
    #arr120.append(file120[1][0:8000])
    file10ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_ctr/dna02_10_0.01_{data}.txt', header=None, delimiter=' ')
    file30ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_ctr/dna02_30_0.01_{data}.txt', header=None, delimiter=' ')
    file90ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_ctr/dna02_90_0.01_{data}.txt', header=None, delimiter=' ')
    #file120ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v2/fig2b/data_ctr/dna02_120_0.01_{data}.txt', header=None, delimiter=' ')
...
plt.plot(x, mean10, label='10˚, no 010&014', color='blue')
plt.plot(x, mean30, label='30˚, no 010&014', color='orange')
plt.plot(x, mean90, label='90˚, no 010&014', color='green')
# plt.plot(x, mean120, label='120˚, no 010&014', color='red')
plt.plot(x, mean10ctr, label='10˚, full model', linestyle='--', color='blue')
plt.plot(x, mean30ctr, label='30˚, full model', linestyle='--', color='orange')
plt.plot(x, mean90ctr, label='90˚, full model', linestyle='--', color='green')
# plt.plot(x, mean120ctr, label='120˚, full model', linestyle='--', color='red')

plt.legend()
plt.xlabel('time (ms)', fontsize=20)
plt.ylabel('mean firingrate difference of DNa02', fontsize=20)
