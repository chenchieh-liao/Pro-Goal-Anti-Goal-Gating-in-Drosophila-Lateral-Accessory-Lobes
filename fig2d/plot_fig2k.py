...
for data in range(1, 51):
    ...
    file10noExc = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no121/dna02_10_0.01_{data}.txt', header=None, delimiter=' ')
    file30noExc = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no121/dna02_30_0.01_{data}.txt', header=None, delimiter=' ')
    file90noExc = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no121/dna02_90_0.01_{data}.txt', header=None, delimiter=' ')
...
labels = ['- LAL040 output', '- LAL121 output', 'Full model', 
          '- LAL040 output', '- LAL121 output', 'Full model', 
          '- LAL040 output', '- LAL121 output', 'Full model']
