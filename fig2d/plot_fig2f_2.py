...
for data in range(1, 51):
    # file10 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no126/dna02_10_0.01_{data}.txt', header=None, delimiter=' ')
    file30 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no126/dna02_60_0.01_{data}.txt', header=None, delimiter=' ')
    file90 = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no126/dna02_90_0.01_{data}.txt', header=None, delimiter=' ')
    ...
    file30ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2b/data_ctr/dna02_60_0.01_{data}.txt', header=None, delimiter=' ')
    ...
    #file120ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no126/dna02_120_0.01_{data}.txt', header=None, delimiter=' ')
    ...
    # file10arr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no073/dna02_10_0.01_{data}.txt', header=None, delimiter=' ')
    file30arr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no073/dna02_60_0.01_{data}.txt', header=None, delimiter=' ')
    file90arr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no073/dna02_90_0.01_{data}.txt', header=None, delimiter=' ')
    #file120ctr = pd.read_csv(f'/home/chieh1102/FPLmodel/open-loop_v5/fig2d/data_no073/dna02_120_0.01_{data}.txt', header=None, delimiter=' ')
...
plt.plot(x, mean30, label='30˚, - LAL126 output', linestyle='--', color='orange',linewidth=8)
plt.plot(x, mean90, label='90˚, - LAL126 output',  linestyle='--', color='green',linewidth=8)
...
plt.plot(x, mean230, label='30˚, - LAL073 output',linestyle=':', color='orange',linewidth=8)
plt.plot(x, mean290, label='90˚, - LAL073 output',linestyle=':', color='green',linewidth=8)
