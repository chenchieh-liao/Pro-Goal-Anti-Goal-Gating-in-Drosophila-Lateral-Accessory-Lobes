...
# prefs.codegen.cpp.msvc_vars_location = 'C:/Program Files (x86)/Microsoft Visual Studio/2019/Professional/VC/Auxiliary/Build/vcvarsall.bat'


start = time.time()
print("START!!")
f = open("para_0701v14.json")
seed_ = int(sys.argv[7])
seed(seed_)
...
def custom_network_operation(t):
    global initialgoal, head, goal,total_input153,total_input017
    ...
    # Phase 5: t >= 102 ms - 進入主迴圈更新動作
        ...
        if not hasattr(custom_network_operation, 'loop_initialized'):
            ...
            total_input153 = int(sys.argv[6])
            total_input017 = int(sys.argv[6])*0.2


            LAL153[0].I = total_input153/2
            LAL153[1].I = total_input153/2
            LAL046[0].I = total_input153/2
            LAL046[1].I = total_input153/2

            LAL017[0].I = total_input017/2
            LAL017[1].I = total_input017/2
        ...
        PFL3.H = head
        PFL2.H = head
        diff = abs((head - initialgoal + 180) % 360 - 180)
        if custom_network_operation.check == 0 and diff > 1.5:
            custom_network_operation.turntime = custom_network_operation.curtime
            custom_network_operation.check = 1
        if head >= 180 and custom_network_operation.check == 1:
        ...
        custom_network_operation.noise_strength = 0.1

        if (goal - head) > 0:
            delta = goal - head
            f3 = open('delta.txt','a+')
            print(delta,file = f3)
            if (delta > 30 and delta < 145):
                LAL153_input = total_input153
                LAL017_input = total_input017
                LAL153[1].I = LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL153[0].I = total_input153 - LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL046[1].I = LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL046[0].I = total_input153 - LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL017[0].I = LAL017_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL017[1].I = total_input017 - LAL017_input + np.random.normal(0, custom_network_operation.noise_strength)
                ...
                LAL153_input  = -(total_input153/1800)*(delta-30)**2 + total_input153
                LAL153[1].I = LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL153[0].I = total_input153 - LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL046_input  = -(total_input153/1800)*(delta-30)**2 + total_input153
                LAL046[1].I = LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL046[0].I = total_input153 - LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL017_input  = -(total_input017/1800)*(delta-30)**2 + total_input017
                LAL017[0].I = LAL017_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL017[1].I = total_input017 - LAL017_input + np.random.normal(0, custom_network_operation.noise_strength)
        else:
            delta = goal - head
            if (delta < -30 and delta > -145):
                LAL153_input = total_input153
                LAL017_input = total_input017
                LAL153[0].I = LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL153[1].I = total_input153 - LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL046[0].I = LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL046[1].I = total_input153 - LAL153_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL017[1].I = LAL017_input + np.random.normal(0, custom_network_operation.noise_strength)
                LAL017[0].I = total_input017 - LAL017_input + np.random.normal(0, custom_network_operation.noise_strength)
            elif (delta <= -165):
                LAL153[0].I = 0
                LAL153[1].I = 0
                LAL046[0].I = 0
...
# f2 = open("full_model.txt", "a+")
# print(sys.argv[6],",",initialgoal,",",custom_network_operation.turntime,",",custom_network_operation.reachtime,",",custom_network_operation.eqtime,",",head,file =f2)
# f2.close()

fig,ax1 = plt.subplots(figsize=[12, 8])
ax2=ax1.twinx()
ax1.plot(trace_DNa02[0].t/ms,trace_DNa02[0].r,color = "red",label="right DNa02",linewidth=4)
ax1.plot(trace_DNa02[1].t/ms,trace_DNa02[1].r,color = "blue",label="left DNa02",linewidth=4)
ax2.scatter(trace_pfl3[1].t/ms,trace_pfl3[1].H,color = "green",s=1,label="goal angle",linewidth=4)
ax2.axhline(y=180,color = "red",label="180 dgree",linestyle='--',linewidth=3.5)
ax1.set_xlabel('Time(ms)',fontsize=20)
ax1.set_ylabel('Firing rate',fontsize=20)
ax1.set_ylim(0,1.1)
ax2.set_ylabel('Head angle',fontsize=20)
ax2.set_ylim(0,360)
# fig.legend(bbox_to_anchor=(0.9,0.4))

ax = plt.gca()
ax1.set_yticklabels(ax.get_yticks(), fontsize=17)
ax1.tick_params(axis='y', width=4, length=12)
ax1.set_yticklabels(ax.get_yticks(), fontsize=17)

ax2.set_yticklabels(ax.get_yticks(), fontsize=17)
ax2.tick_params(axis='y', width=4, length=12)
ax2.set_yticklabels(ax.get_yticks(), fontsize=17)

ax1.tick_params(axis='x', width=4, length=12)
ax1.set_xticklabels(ax.get_xticks(), fontsize=17)
...
plt.savefig("cl2-1.svg")
plt.savefig("cl2-1.png")
...
# Add a common x-axis label
fig.text(0.5, 0.04, 'time (ms)', ha='center')
plt.savefig('dns-a.png')

fig2,ax1 = plt.subplots()
ax2=ax1.twinx()
ax1.scatter(trace_lal153[0].t,trace_lal153[0].I,color = "red",s=1,label="153_R")
ax1.scatter(trace_lal153[1].t,trace_lal153[1].I,color = "blue",s=1,label="153_L")
ax2.scatter(trace_lal017[1].t,trace_lal017[1].I,color = "green",s=1,label="left input")
ax2.scatter(trace_lal017[0].t,trace_lal017[0].I,color = "orange",s=1,label="right input")
ax1.set_xlabel('time(s)')
ax1.set_ylabel('r')
ax1.set_ylim(0,1.1)
ax2.set_ylabel('input current')
ax2.set_ylim(0,50)
fig2.legend(bbox_to_anchor=(0.9,0.4))
plt.savefig("cl2-2.png")
