...
Ihead : 1 #input from delta7/Elesion/LAL010
Iin : 1
...
IFC2 : 1 # input from FC2
Ihead_2 : 1 #input from delta7/Elesion/LAL010
Iin : 1
s1: 1
s2: 1
H: 1
...
def custom_network_operation(t):
    ...
    # Phase 5: t >= 102 ms - 進入主迴圈更新動作
        ...
        if t > 200*ms:
            LAL153[1].I = int(sys.argv[6])
            LAL046[1].I = int(sys.argv[6])
            LAL017[0].I = int(sys.argv[6])*0.6
        ...
        if custom_network_operation.check == 0 and head > (initialgoal + 1):
...
ax1.tick_params(axis='y', width=4, length=15)
ax1.set_yticklabels(ax.get_yticks(), fontsize=17)

ax2.set_yticklabels(ax.get_yticks(), fontsize=17)
ax2.tick_params(axis='y', width=4, length=15)
ax2.set_yticklabels(ax.get_yticks(), fontsize=17)

ax1.tick_params(axis='x', width=4, length=15)
...
plt.savefig("cl017-1.svg")
plt.savefig("cl017-1.png")
...
plt.savefig("cl1-2.png")

output_files = [
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_DNa01.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_DNa02.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_DNa03.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_DNa04.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL010.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL014.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL018.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL040.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL046.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL121.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL073.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL122.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL126.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL153.txt',
    f'/home/chieh1102/FPLmodel/2025_fig5_v2/lesion/LAL017/dna02_{sys.argv[2]}_LAL017.txt',
]
