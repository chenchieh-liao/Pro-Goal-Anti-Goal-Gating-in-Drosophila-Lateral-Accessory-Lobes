...
ax2=ax1.twinx()
ax1.plot(trace_DNa02[0].t/ms,trace_DNa02[0].r,color = "red",label="DNa02_R",linewidth=4)
ax1.plot(trace_DNa02[1].t/ms,trace_DNa02[1].r,color = "blue",label="DNa02_L",linewidth=4)
ax2.scatter(trace_pfl3[1].t/ms,trace_pfl3[1].H,color = "green",s=1,label="Head",linewidth=4)
ax2.axhline(y=180,color = "red",label="Goal",linestyle='--',linewidth=3.5)
ax1.set_xlabel('Time(ms)',fontsize=25)
ax1.set_ylabel('Firing rate',fontsize=25)
ax1.set_ylim(0,1.1)
ax2.set_ylabel('Head angle',fontsize=25)
ax2.set_ylim(0,360)
fig.legend(bbox_to_anchor=(0.85,0.4),fontsize=20)

ax = plt.gca()
ax1.set_yticklabels(ax.get_yticks(), fontsize=20)
ax1.tick_params(axis='y', width=4, length=15)
ax1.set_yticklabels(ax.get_yticks(), fontsize=20)

ax2.set_yticklabels(ax.get_yticks(), fontsize=20)
ax2.tick_params(axis='y', width=4, length=15)
ax2.set_yticklabels(ax.get_yticks(), fontsize=20)

ax1.tick_params(axis='x', width=4, length=15)
ax1.set_xticklabels(ax.get_xticks(), fontsize=20)
...
plt.tight_layout()
plt.savefig("cl1-1.svg")
plt.savefig("cl1-1.png")
...
# output_files = [
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_DNa01.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_DNa02.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_DNa03.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_DNa04.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL010.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL014.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL018.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL040.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL046.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL121.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL073.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL122.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL126.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL153.txt',
#     f'/home/chieh1102/FPLmodel/2025_fig5_v2/AG/dna02_{sys.argv[2]}_LAL017.txt',
# ]
